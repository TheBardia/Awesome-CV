...
\geometry{left=1.4cm, top=0.3cm, right=1.0cm, bottom=0.6cm, footskip=0.1cm}
...
\mobile{(+1) 226-820-6469}
\email{bardiagoharanpour@yahoo.com}
% \homepage{www.aliniaki.me}
\github{thebardia}
\linkedin{bardiagoharanpour}
% \gitlab{gitlab-id}
