  ...
  \cventry
    ...
    {North York, Ontario, CA} % Location
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Relevant topics include: \importantstyle{C}, \importantstyle{Java}, \importantstyle{Operating Systems}, Web Development, Databases, and more}
