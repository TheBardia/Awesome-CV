    ...
    \begin{cvitems} % Description(s) of tasks/responsibilities
      ...
      \item {Developed a \importantstyle{web interface} for the employees to access the submitted entries, with the ability to}
        \begin{cvsubitems}
          ...
          \item {Dynamically \importantstyle{generate PDF} reports by picking which entries to be included, saving the company \importantstyle{1.5 hours per site visit each day}, estimated at \importantstyle{30 hours per week} in our department}
        \end{cvsubitems}
